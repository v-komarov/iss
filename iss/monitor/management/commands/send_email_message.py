    ...
    def handle(self, *args, **options):
        ...
        for m in messages.objects.filter(send_done=False):
            ...
            if m.data["acc_email_templates"] in ['1', '3', '5']:
                ...
                body = temp.template.format(accnum=acc_number,begin=m.data["acc_datetime_begin"],acctype=acc_type_cat,stoplist=m.data["acc_service_stoplist"],reason=m.data["acc_reason"],cities=m.data["acc_cities"],addresslist=m.data["acc_address_list"].replace(";","; "),acczkl=m.data["acc_zkl"],repairend=m.data["acc_repair_end"])
            ...
            ### Выбор сообщений с оповещение об устранении аварии на МСС
                ...
                body = temp.template.format(accnum=acc_number, begin=m.data["acc_datetime_begin"], acctype=acc_type_cat,
                                            ...
                                            cities=m.data["acc_cities"], addresslist=m.data["acc_address_list"].replace(";","; "),
